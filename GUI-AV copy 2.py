...
def cores():
    Fire_Reported = 0
    global slider1, slider11, slider2, slider22, slider33, detcolor, frame, vefCores, vefEmail, area, Email_Status, detectou, comecou
    comecou = True
...
color = Button(tela, text="Colores", image= imagemBC, height="40", width="200", command=start_doing_slow_stuff)
